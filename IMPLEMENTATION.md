...
2. capture-issue.yml workflow triggers
   ↓
3. Authorization check: ✓ AUTHORIZED
   ↓
...
2. capture-issue.yml workflow triggers
   ↓
3. Authorization check: ✗ NOT AUTHORIZED
   ↓
...
✅ **Authorization & Token Protection**
